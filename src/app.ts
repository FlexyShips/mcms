...
import { waitlistRouter, adminWaitlistRouter } from './modules/waitlist/waitlist.routes.js';
...
export function createApp() {
  ...
  app.use((req, _res, next) => {
    next(
      new HttpError(404, `Route not found: ${req.method} ${req.originalUrl}`, 'ROUTE_NOT_FOUND'),
    );
  });
